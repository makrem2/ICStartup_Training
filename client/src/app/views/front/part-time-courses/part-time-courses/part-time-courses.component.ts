...
@Component({
  selector: 'app-part-time-courses',
  templateUrl: './part-time-courses.component.html',
  styleUrls: ['./part-time-courses.component.css'],
})
export class PartTimeCoursesComponent implements OnInit {
  emaill: any;
  datacategorie: any = [];
  messageErr = '';
  messagesucces = '';
