...
export class DataService {
  ...
  deletecategorie(id: any) {
    return this.http.delete(
      'http://localhost:3000/api/category/deletecategorie/' + id
    );
  }
  ...
  addformations(formation: any) {
    return this.http.post(
      'http://localhost:3000/api/formation/addFormation',
      formation
    );
  }
  ...
  updateformations(id: any, formation: any) {
    return this.http.post(
      'http://localhost:3000/api/formation/updateFormation/' + id,
      formation
    );
  }
  ...
  getFormationByCategorie(id: any) {
    return this.http.get(
      'http://localhost:3000/api/formation/getFormationByCategorie/' + id
    );
  }
  ...
  deleteformation(id: any) {
    return this.http.delete(
      'http://localhost:3000/api/formation/deleteFormation/' + id
    );
  }
  ...
  addformateur(formateur: any) {
    return this.http.post(
      'http://localhost:3000/api/formateur/addFormateur',
      formateur
    );
  }
  ...
  deleteformateur(id: any) {
    return this.http.delete(
      'http://localhost:3000/api/formateur/deleteFormateur/' + id
    );
  }
  ...
  addevenement(formateur: any) {
    return this.http.post(
      'http://localhost:3000/api/evenement/addEvenement',
      formateur
    );
  }
  ...
  deleteevenement(id: any) {
    return this.http.delete(
      'http://localhost:3000/api/evenement/deleteEvenement/' + id
    );
  }
  ...
  addEtudiant(etudiant: any) {
    return this.http.post(
      'http://localhost:3000/api/etudiant/addEtudiant',
      etudiant
    );
  }
  ...
  deleteEtudiant(id: any) {
    return this.http.delete(
      'http://localhost:3000/api/etudiant/deleteEtudiant/' + id
    );
  }

  getOneEtudiant(id: any) {
    return this.http.get(
      'http://localhost:3000/api/etudiant/getOneEtudiant/' + id
    );
  }
  ...
  addCommentaire(commentaire: any) {
    return this.http.post(
      'http://localhost:3000/api/commentaire/addCommentaire',
      commentaire
    );
  }
  ...
  deleteCommentaire(id: any) {
    return this.http.delete(
      'http://localhost:3000/api/commentaire/deleteCommentaire/' + id
    );
  }


  getCommentaireByBlog(id: any) {
    return this.http.get(
      'http://localhost:3000/api/commentaire/getCommentaireByBlog/' + id
    );
  }
